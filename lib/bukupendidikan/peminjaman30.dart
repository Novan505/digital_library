...
class Pinjam30 extends StatefulWidget {
  const Pinjam30({Key? key}) : super(key: key);

  @override
  State<Pinjam30> createState() => _Pinjam30State();
}

class _Pinjam30State extends State<Pinjam30> {
  @override
