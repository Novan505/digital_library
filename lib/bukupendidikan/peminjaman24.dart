...
class Pinjam24 extends StatefulWidget {
  const Pinjam24({Key? key}) : super(key: key);

  @override
  State<Pinjam24> createState() => _Pinjam24State();
}

class _Pinjam24State extends State<Pinjam24> {
  @override
