...
class Pinjam12 extends StatefulWidget {
  const Pinjam12({Key? key}) : super(key: key);

  @override
  State<Pinjam12> createState() => _Pinjam12State();
}

class _Pinjam12State extends State<Pinjam12> {
  @override
