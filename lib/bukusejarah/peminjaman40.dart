...
class Pinjam40 extends StatefulWidget {
  const Pinjam40({Key? key}) : super(key: key);

  @override
  State<Pinjam40> createState() => _Pinjam40State();
}

class _Pinjam40State extends State<Pinjam40> {
  @override
