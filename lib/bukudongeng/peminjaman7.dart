...
class Pinjam7 extends StatefulWidget {
  const Pinjam7({Key? key}) : super(key: key);

  @override
  State<Pinjam7> createState() => _Pinjam7State();
}

class _Pinjam7State extends State<Pinjam7> {
  @override
