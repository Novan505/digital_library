...
class Pinjam2 extends StatefulWidget {
  const Pinjam2({Key? key}) : super(key: key);

  @override
  State<Pinjam2> createState() => _Pinjam2State();
}

class _Pinjam2State extends State<Pinjam2> {
  @override
