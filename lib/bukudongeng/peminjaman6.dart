...
class Pinjam6 extends StatefulWidget {
  const Pinjam6({Key? key}) : super(key: key);

  @override
  State<Pinjam6> createState() => _Pinjam6State();
}

class _Pinjam6State extends State<Pinjam6> {
  @override
